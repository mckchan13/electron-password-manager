...
const electronAPI = {
    ...
    encryptPassword: ({
        ...
        return ipcRenderer.invoke("encrypt-password", [username, password, secretKey]);
    },
} as const;
...
function invokePortRequest(channel: string): (request: RequestObject) => Promise<ResponseObject> {
